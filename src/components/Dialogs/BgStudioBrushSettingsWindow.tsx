...
export interface BgStudioBrushSettingsWindowProps {
  open: boolean;
...
export function BgStudioBrushSettingsWindow({
  open,
  onOpenChange,
  initialBrushType = 1,
  initialBrushSize = 20,
  ...
  onApply,
}: BgStudioBrushSettingsWindowProps) {
  ...
  const gradientId = 'bgstudio-brush-gradient';
  ...
  const footer = (
    <>
      <button
        ...
        data-testid="bgstudio-brush-settings-cancel"
      >
        Cancel
      </button>
      <button
        ...
        data-testid="bgstudio-brush-settings-apply"
      >
        Apply
      </button>
    </>
  ...
  return (
    <DialogBase
      ...
      title="BG Studio Brush Settings"
      width={380}
      footer={footer}
    >
      <div className="flex flex-col gap-4 p-4" data-testid="bgstudio-brush-settings-content">
        {/* Section label */}
        <span
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-1">
            <button
              ...
              data-testid="bgstudio-brush-type-block"
            >
            ...
            <button
              ...
              data-testid="bgstudio-brush-type-circle"
            >
              <svg width="14" height="14" viewBox="0 0 14 14" style={{ marginRight: 4 }}>
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            data-testid="bgstudio-brush-size-slider"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="flex-1"
            style={{ accentColor: 'var(--accent-orange)' }}
            data-testid="bgstudio-brush-hardness-slider"
          />
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <div
            ...
            data-testid="bgstudio-brush-preview"
          >
...
export default BgStudioBrushSettingsWindow;
